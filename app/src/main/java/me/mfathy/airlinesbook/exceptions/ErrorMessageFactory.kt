package me.mfathy.airlinesbook.exceptions
...
object ErrorMessageFactory {
    ...
    fun create(context: Context, exception: Throwable): String {
        ...
        when (exception) {
            is me.mfathy.airlinesbook.data.exceptions.NetworkConnectionException -> message = context.resources.getString(R.string.exception_message_no_connection)
            is me.mfathy.airlinesbook.data.exceptions.AuthException -> message = context.resources.getString(R.string.exception_message_auth_error)
            is me.mfathy.airlinesbook.data.exceptions.NoAirportsException -> message = context.resources.getString(R.string.exception_message_no_airports)
            is me.mfathy.airlinesbook.data.exceptions.NoFlightsException -> message = context.resources.getString(R.string.exception_message_no_flights)
            is HttpException -> {
